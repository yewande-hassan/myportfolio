...
export const Navbar = () => {
  ...
  return (
    <nav className='h-[12vh] flex justify-between items-center'>
      ...
      <div
          onClick={toggleMenu}
          className='inline-flex items-center relative right-[1rem] justify-center rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white lg:hidden'
        >
